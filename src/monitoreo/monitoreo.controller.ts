...
export class MonitoreoController {
  ...
  @ApiOperation({
    ...
    description: [
      ...
      '- **Vehículo (1):** cliente, placa, económico, marca, modelo, ignición, velocidad, fechaHora, nivelCombustible, odometro, gps, gsm, lat, lng.',
      '- **Activo (2):** cliente, imei, descripcion, economico, numeroSerie, estatus, odometro, gps, gsm, modelo, marca, fechaHora, ultimaPosicion, lat, lng.',
      ...
      '- **Persona / teléfono (4):** cliente, imei, persona, economico, numeroSerie, estatus, odometro, gps, gsm, modelo, marca, fechaHora, ultimaPosicion, lat, lng.',
      '',
